...
class BankAccount:
    ...
    def deposit(self, amount: int) -> int:
        ...
        if self.transactions == []:
            ...
            self.transactions.append(Transaction(new_transaction_id, 0, self.balance))
        else:
            new_transaction_id = self.transactions[-1].id+1
            self.transactions.append(Transaction(new_transaction_id, self.balance, self.balance+amount))
            self.balance += amount
        return self.balance
    ...
    def withdraw(self, amount: int) -> int | str:
        ...
        if amount > self.balance:
            if self.transactions == []:
                self.transactions.append(Transaction(0, amount, amount))
            else:
                self.transactions.append(Transaction(self.transactions[-1].id+1, amount, amount))
...
class Client:
    ...
    def compose(self, message: str, recipient_name: str):
        ...
        email = Email(message, self, self.server.clients[recipient_name])
